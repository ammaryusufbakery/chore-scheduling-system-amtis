            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="border-b border-gray-200 px-4 py-4 sm:px-6 sm:py-5">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Update the details of {{ $junior->name }}.
                    </p>
                </div>

                {{-- Form --}}
                <form action="{{ route('juniors.update', $junior) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6 p-4 sm:p-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="email"
                                id="email"
                                value="{{ old('email', $junior->user->email) }}"
                                required
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            >
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option
                                    value="Male"
                                    {{ old('gender', $junior->gender) === 'Male' ? 'selected' : '' }}
                                >
                                    Male
                                </option>
                                ...
                                <option
                                    value="Female"
                                    {{ old('gender', $junior->gender) === 'Female' ? 'selected' : '' }}
                                >
                                    Female
                                </option>
                            </select>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="start_date"
                                    id="start_date"
                                    value="{{ old('start_date', $junior->start_date) }}"
                                    required
                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="end_date"
                                    id="end_date"
                                    value="{{ old('end_date', $junior->end_date) }}"
                                    required
                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                >
                                ...
                                @foreach ($preferences as $preference)
                                    <label class="flex items-center gap-3 rounded-lg border border-gray-200 p-3 hover:bg-gray-50">
                                        <input
                                            ...
                                            name="preferences[]"
                                            value="{{ $preference }}"
                                            {{ in_array($preference, $selectedPreferences) ? 'checked' : '' }}
                        ...
                        <div>
                            ...
                            >
                                <option
                                    value="Active"
                                    {{ old('status', $junior->status) === 'Active' ? 'selected' : '' }}
                                >
                                    Active
                                </option>
                                ...
                                <option
                                    value="Inactive"
                                    {{ old('status', $junior->status) === 'Inactive' ? 'selected' : '' }}
                                >
                                    Inactive
                                </option>
                            </select>
