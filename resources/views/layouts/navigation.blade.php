<nav x-data="{ open: false }" class="border-b border-gray-100 bg-white">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-8 sm:flex">
                    @if (auth()->user()->role_id === 2)
                        <x-nav-link :href="route('junior-dashboard')" :active="request()->routeIs('junior-dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    @else
                    ...
                    <x-nav-link :href="route('recital')" :active="request()->routeIs('recital')">
                        {{ __('Recital') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="space-y-1 pb-3 pt-2">
            @if (auth()->user()->role_id === 2)
                <x-responsive-nav-link :href="route('junior-dashboard')" :active="request()->routeIs('junior-dashboard')">
                    {{ __('Dashboard') }}
            ...
            <x-responsive-nav-link :href="route('shutter')" :active="request()->routeIs('shutter')">
                {{ __('Shutter') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('recital')" :active="request()->routeIs('recital')">
                {{ __('Recital') }}
            </x-responsive-nav-link>
